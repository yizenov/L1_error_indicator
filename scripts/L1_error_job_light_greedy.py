...
2. Run the following command: /usr/bin/python3 scripts/L1_error_job_light_greedy.py arg1\n \
...
if len(sys.argv) != 2:
    ...
    try:
        ...
        if is_compass not in [0, 1]: 
            ...
            true_cost_data_file = "input_data/job_light/greedy_traversals-opt-cost.csv"
            if is_compass:
                cardinality_file, est_index = "input_data/job_light/results_estimates-JOB-light.csv", 4
                plans_file = "input_data/job_light/greedy_traversals-opt-cost-compass.csv"
                output_f_file = "input_data/job_light/L1-light-errors-agg-greedy-compass.csv"
            else:
                cardinality_file, est_index = "input_data/job_light/results_estimates-JOB-light.csv", 3
                plans_file = "input_data/job_light/greedy_traversals-opt-cost-psql.csv"
                output_f_file = "input_data/job_light/L1-light-errors-agg-greedy-psql.csv"
